---
title: "Memoria del Proyecto: ShinyVillage"
...
**Índice**
- [Memoria del Proyecto: ShinyVillage](#memoria-del-proyecto-shinyvillage)
- [Descripción del proyecto](#descripción-del-proyecto)
  - [1.1 Introducción](#11-introducción)
  - [1.2 Contexto del proyecto](#12-contexto-del-proyecto)
  - [1.3 Objetivo del proyecto](#13-objetivo-del-proyecto)
  - [1.4 Marco legal](#14-marco-legal)
    - [Protección de datos (RGPD / LOPDGDD)](#protección-de-datos-rgpd--lopdgdd)
    - [Propiedad intelectual](#propiedad-intelectual)
    - [Clasificación por edades](#clasificación-por-edades)
- [Acuerdo del proyecto](#acuerdo-del-proyecto)
  - [2.1 Requisitos funcionales y no funcionales](#21-requisitos-funcionales-y-no-funcionales)
    - [Requisitos funcionales](#requisitos-funcionales)
    - [Requisitos no funcionales](#requisitos-no-funcionales)
  - [2.2 Planificación de tareas y temporalización](#22-planificación-de-tareas-y-temporalización)
  - [2.3 Metodología a seguir](#23-metodología-a-seguir)
  - [2.4 Temporalización](#24-temporalización)
  - [2.5 Presupuesto](#25-presupuesto)
  - [2.6 Contrato y pliego de condiciones/licencia](#26-contrato-y-pliego-de-condicioneslicencia)
  - [2.7 Análisis de riesgos](#27-análisis-de-riesgos)
- [Análisis y diseño](#análisis-y-diseño)
  - [3.1 Modelado de datos](#31-modelado-de-datos)
    - [3.1.1 Modelo E/R](#311-modelo-er)
    - [3.1.2 Modelo relacional del sistema de guardado](#312-modelo-relacional-del-sistema-de-guardado)
    - [3.1.3 Script de la creación de la BBDD (SQLite)](#313-script-de-la-creación-de-la-bbdd-sqlite)
  - [3.2 Análisis y diseño funcional](#32-análisis-y-diseño-funcional)
    - [3.2.1 UML (Clases, secuencia y casos de uso)](#321-uml-clases-secuencia-y-casos-de-uso)
      - [Diagramas de clases](#diagramas-de-clases)
      - [Diagramas de secuencia](#diagramas-de-secuencia)
      - [Diagrama de casos de uso](#diagrama-de-casos-de-uso)
    - [3.2.2 Diagrama de flujo](#322-diagrama-de-flujo)
    - [3.2.3 Diagrama de estados](#323-diagrama-de-estados)
    - [3.2.4 Descomposición en módulos](#324-descomposición-en-módulos)
  - [3.3 Análisis y diseño de la interfaz](#33-análisis-y-diseño-de-la-interfaz)
    - [3.3.1 Mockups](#331-mockups)
    - [3.3.2 Diseño visual](#332-diseño-visual)
  - [3.4 Análisis y diseño de la arquitectura](#34-análisis-y-diseño-de-la-arquitectura)
    - [3.4.1 Tecnologías usadas y herramientas](#341-tecnologías-usadas-y-herramientas)
    - [3.4.2 Arquitectura de los componentes](#342-arquitectura-de-los-componentes)
...
| **Destinatarios** | El juego contempla como único tipo de usuario el jugador. Su rol dentro del sistema le permite crear y modificar partidas desde el menú, así como el movimiento de un personaje y sus decisiones sobre la interacción con el mapa. También puede gestionar su inventario decidiendo qué objetos soltar y cuáles conservar. No se contempla ningún rol de administrador ni perfil técnico dentro de la experiencia de juego. Toda la gestión interna (base de datos, repositorios, gestores) es transparente para el jugador y opera de forma automática en segundo plano. |
...
Como se trata de un proyecto sin un cliente externo, no hay contrato de prestación de servicios.
El acuerdo de desarrollo queda recogido en los términos de entregas del centro formativo.
...
![Modelo E/R](diagrams/png/er.png)

### 3.1.2 Modelo relacional del sistema de guardado

![Modelo relacional](diagrams/png/relation.png)
...
![Diagrama de clases general](diagrams/png/clases_summary.png)

**Diagrama desglosado: Gameplay**

![Diagrama de clases Gameplay](diagrams/png/clases_gameplay.png)

**Diagrama desglosado: Saving System (Guardado)**

![Diagrama de clases Saving System](diagrams/png/clases_save.png)

**Diagrama desglosado: Main Menu**

![Diagrama de clases Main Menu](diagrams/png/clases_main_menu.png)

#### Diagramas de secuencia

![Secuencia nueva partida](diagrams/png/nueva_partida_sequence.png)

![Secuencia cargar partida](diagrams/png/cargar_partida_sequence.png)

#### Diagrama de casos de uso

![Diagrama de casos de uso](diagrams/png/uso.png)

### 3.2.2 Diagrama de flujo

![Diagrama de flujo](diagrams/png/flujo.png)

### 3.2.3 Diagrama de estados

![Diagrama de estados](diagrams/png/estados.png)

### 3.2.4 Descomposición en módulos

![Descomposición en módulos](diagrams/png/modulos.png)

## 3.3 Análisis y diseño de la interfaz

### 3.3.1 Mockups

Para el diseño de los mockups se ha utilizado GoodNotes 6 en PadOS (IPad 10) debido a sus prestaciones como aplicación de notas y esbozos de forma sencilla. En ella, se han realizado los mockups de las principales escenas y menús de la aplicación.

![Mockups](diagrams/Mockups.jpg)
...
![Cargar partida](img/load.png)

Interfaz de juego:

![Interfaz de juego](img/tilemap.png)
...
![Diagrama de capas](diagrams/png/LayerDiag.png)
